...
String stName = jTextField3.getText(); 
String stContact = jTextField5.getText();  
Date d   =  new Date(System.currentTimeMillis());
        try {
            IssuedBooks.issueBook(callno, stID ,stName, stContact, d);
        } catch (FileNotFoundException ex) {
            Logger.getLogger(AddBook.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.hide();
new BookIssueSuccess().setVisible(true);  // TODO add your handling code here:

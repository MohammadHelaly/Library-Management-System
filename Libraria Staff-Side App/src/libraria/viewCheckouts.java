 ...
 * @author Helaly
 */
public class viewCheckouts extends javax.swing.JFrame {

    /**
     * Creates new form viewCheckouts
     */
    public viewCheckouts() {
        initComponents();
                setExtendedState(viewCheckouts.MAXIMIZED_BOTH); 
        populateTable();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Checkout ID", "Customer ID", "Customer Name", "Book Call #", "Book Title", "Quantity", "Branch ID", "Checkout date", "Pickup date", "Return date", "Status", "Payment due", "Fine"
            }
        ) {
        ...
        jLabel16.setText("Checkout date:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewCheckouts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
  ...
  String checkoutIdFilter = jTextField1.getText().trim();
    ...
    String checkoutDateFilter = jTextField6.getText().trim();
    String pickupDateFilter = jTextField9.getText().trim();
    String returnDateFilter = jTextField2.getText().trim();
    String statusFilter = jTextField7.getText().trim();
    ...
    try (Connection connection = DBConnection.getConnection()) {
        StringBuilder queryBuilder = new StringBuilder("SELECT c.id AS checkout_id, c.customer_id, cus.name AS customer_name, " +
                "b.title AS book_title,b.call_num AS book_call_num,ci.quantity AS quantity, c.branch_id, c.checkout_date, c.pickup_date, c.return_date, c.status, ci.payment_due, c.fine " +
                "FROM checkout c " +
        ...
        if (!checkoutDateFilter.isEmpty()) {
            queryBuilder.append(" AND c.checkout_date LIKE ?");
        }
        if (!pickupDateFilter.isEmpty()) {
            queryBuilder.append(" AND c.pickup_date LIKE ?");
        }
        if (!returnDateFilter.isEmpty()) {
            queryBuilder.append(" AND c.return_date LIKE ?");
        }
        if (!statusFilter.isEmpty()) {
            queryBuilder.append(" AND c.status LIKE ?");
        }
        ...
        if (!checkoutDateFilter.isEmpty()) {
            statement.setString(parameterIndex++, "%" + checkoutDateFilter + "%");
        }
        if (!pickupDateFilter.isEmpty()) {
            statement.setString(parameterIndex++, "%" + pickupDateFilter + "%");
        }
        if (!returnDateFilter.isEmpty()) {

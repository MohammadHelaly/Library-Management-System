...
import static pkg6870_6952_assignment2.Librarians.addLibrarian;
import static pkg6870_6952_assignment2.Librarians.count;
import static pkg6870_6952_assignment2.Librarians.saveFile;
...
this.hide();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int id = count+1;
        try {
            Librarians.addLibrarian(id, name, password, email, address, city, contact);
        } catch (FileNotFoundException ex) {
            Logger.getLogger(AddLibrarian.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.hide();
        new LibrarianAddSuccessful().setVisible(true);        // TODO add your handling code here:

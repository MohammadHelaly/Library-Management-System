...
public class librarianLogin extends javax.swing.JFrame {
    ...
    public librarianLogin() {
        initComponents();
        setExtendedState(librarianLogin.MAXIMIZED_BOTH);
    }
    ...
    private boolean authenticateLibrarian(String name, String password) {
        try (Connection connection = DBConnection.getConnection();
        PreparedStatement statement = connection.prepareStatement("SELECT * FROM librarian WHERE name = ? AND password = md5(?)")) {
        ...
        try (ResultSet resultSet = statement.executeQuery()) {
            if (resultSet.next()) {
                ...
                sessionManager.setLibrarianId(id);
